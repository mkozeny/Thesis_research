...
\begin{itemize}
  ...
  \item to fulfil target \verb|P|, it is necessary \textbf{first} to fulfil
...
Since Java 5.0 release, general purpose of annotation was ability to define
and use own annotation types. The facility consists of a syntax for declaring
annotation types, a syntax for annotating declarations, APIs for reading
annotations, a class file representation for annotations.
...
This is simple annotation typically used for entity field e.g. of type
...
Annotation type without any with no elements is called \textit{marker}
annotation type, e.g.:
...
(\verb|@Target(ElementType.METHOD)|) indicates, that annotation type should
be used to annotate only method declarations:
