...
declarative logic and imperative programming. That was written in theoretical
part and what are the experiences. Of course when using this framework,
programme allocates more memory, sometimes throws out of memory exception,
computes bad result and so on. But how elegant was declaring algorithm instead
of writing lot of code telling system how to compute something. In my opinion
Squander provides quality API for declaration of algorithms with wide range of
operators and expressions provided by JSFL language. Sometimes is quite hard to
declare problem easily, because some operators and expressions are missing
...
operators). Supporting only first order logic can be also \ldots 
