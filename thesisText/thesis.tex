...
duplicate elements. The only thing I have needed for implementation is a help
data structure \verb|allExtendedNodes| for checking, whether all nodes in result
set with its neighborhood covered whole graph with precondition of empty set
\ref{ldomset5}.
