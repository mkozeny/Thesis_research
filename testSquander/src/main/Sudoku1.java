...
public class Sudoku1 {
    ...
    //   @Invariant("all c1 : Cell | all c2 : Cell | (c1 != c2 && !c1.empty && !c2.empty && (c1 + c2) in this.cells.elems[int]) => c1.value != c2.value")
	...
	@Invariant("all v1 : int @- 0 | lone this.cells.elems.value.v1")
